...
python create_ips.py ..\build\00.sfc ..\build\ff.sfc ..\build\TrueCompletionVerification_v1.0.ips
...
python create_ips.py ..\build\00.sfc ..\build\ff.sfc ..\build\MapCompletionVerification_v1.0.ips
...
python create_ips.py ..\build\00.sfc ..\build\ff.sfc ..\build\AllDoorsVerification_v1.0.ips
